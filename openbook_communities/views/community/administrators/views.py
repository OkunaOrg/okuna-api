...
class CommunityAdministrators(APIView):
    ...
    def get(self, request, community_name):
        ...
        banned_users = user.get_community_with_name_administrators(community_name=community_name, max_id=max_id)[:count]

        response_serializer = GetCommunityAdministratorsUserSerializer(banned_users, many=True,
    ...
    def put(self, request, community_name):
        ...
        return ApiMessageResponse('Added administrator to community.', status=status.HTTP_200_OK)
