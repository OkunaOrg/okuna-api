...
```bash
usage: manage.py allocate_invites [-h] [--count INCREMENT_INVITES_BY_COUNT] [--total TOTAL_INVITE_COUNT_TO_SET] [--limit MAX_AMOUNTS_OF_INVITES_TO_GIVE] [--username USERNAME]
```
