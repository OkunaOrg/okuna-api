...
from openbook_posts.queries import make_only_posts_with_hashtag_with_id, make_exclude_soft_deleted_posts_query, \
    ...
    make_only_visible_community_posts_for_user_with_id_query, make_exclude_closed_posts_query
...
def make_get_hashtag_posts_query_for_user(hashtag, user):
    ...
    hashtag_posts_query.add(make_only_visible_community_posts_for_user_with_id_query(user_id=user.pk), Q.AND)

    # Dont retrieve excluded posts
