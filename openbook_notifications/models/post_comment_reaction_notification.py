...
class PostCommentReactionNotification(models.Model):
    ...
    @classmethod
    def create_post_comment_reaction_notification(cls, post_comment_id, owner_id):
        post_comment_reaction_notification = cls.objects.create(post_comment_id=post_comment_id)
    ...
    @classmethod
    def delete_post_comment_reaction_notification(cls, post_comment_id, owner_id):
        cls.objects.filter(post_comment_id=post_comment_id,
                           notification__owner_id=owner_id).delete()

    @classmethod
    def delete_post_comment_reaction_notifications(cls, post_comment_id):
