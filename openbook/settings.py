...
MIN_ACTIVITY_SCORE_FOR_POST_TRENDING = float(os.environ.get('MIN_ACTIVITY_SCORE_FOR_POST_TRENDING', 0.002))
MIN_ACTIVITY_SCORE_FOR_COMMUNITY_TRENDING = float(os.environ.get('MIN_ACTIVITY_SCORE_FOR_COMMUNITY_TRENDING', 0.002))
ACTIVITY_ATOMIC_WEIGHT = float(os.environ.get('ACTIVITY_ATOMIC_WEIGHT', 0.001))
...
ACTIVITY_UNIQUE_REACTION_WEIGHT = float(ACTIVITY_ATOMIC_WEIGHT * ACTIVITY_UNIQUE_REACTION_MULTIPLIER)
ACTIVITY_UNIQUE_COMMENT_WEIGHT = float(ACTIVITY_ATOMIC_WEIGHT * ACTIVITY_UNIQUE_COMMENT_MULTIPLIER)
ACTIVITY_COUNT_COMMENTS_WEIGHT = float(ACTIVITY_ATOMIC_WEIGHT * ACTIVITY_COUNT_COMMENTS_MULTIPLIER)
ACTIVITY_UNIQUE_POST_WEIGHT = float(ACTIVITY_ATOMIC_WEIGHT * ACTIVITY_UNIQUE_POST_MULTIPLIER)
ACTIVITY_COUNT_POSTS_WEIGHT = float(ACTIVITY_ATOMIC_WEIGHT * ACTIVITY_COUNT_POSTS_MULTIPLIER)
