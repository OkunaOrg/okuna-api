...
MODERATORS_COMMUNITY_NAME = os.environ.get('MODERATORS_COMMUNITY_NAME')

if not MODERATORS_COMMUNITY_NAME:
    raise Exception('MODERATORS_COMMUNITY_NAME env variable is required')
